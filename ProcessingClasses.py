...
# AAsgekar,6.15.2020,Modified read_data_from_file
# ---------------------------------------------------------- #
...
class FileProcessor:
    ...
    changelog: (When,Who,What)
        ...
        AAsgekar,6.15.2020,Added exception clause to read_data_from_file
        AAsgekar,6.15.2020,Modified row definition in read_data_from_file
    """
